...
export namespace Prisma {
  ...
  */
  ...
  type GetTemplateGroupByPayload<T extends TemplateGroupByArgs> = PrismaPromise<
    Array<
  ...
  export type TemplateGetPayload<
    S extends boolean | null | undefined | TemplateArgs,
    U = keyof S
      > = S extends true
        ? Template
    : S extends undefined
    ? never
    : S extends TemplateArgs | TemplateFindManyArgs
    ?'include' extends U
    ? Template 
    : 'select' extends U
    ? {
  ...
  type TemplateCountArgs = Merge<
    Omit<TemplateFindManyArgs, 'select' | 'include'> & {
      select?: TemplateCountAggregateInputType | true
    }
  >

  export interface TemplateDelegate<GlobalRejectSettings> {
    /**
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Template'> extends True ? CheckSelect<T, Prisma__TemplateClient<Template>, Prisma__TemplateClient<TemplateGetPayload<T>>> : CheckSelect<T, Prisma__TemplateClient<Template | null >, Prisma__TemplateClient<TemplateGetPayload<T> | null >>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Template'> extends True ? CheckSelect<T, Prisma__TemplateClient<Template>, Prisma__TemplateClient<TemplateGetPayload<T>>> : CheckSelect<T, Prisma__TemplateClient<Template | null >, Prisma__TemplateClient<TemplateGetPayload<T> | null >>
    ...
    **/
    ...
    ): CheckSelect<T, PrismaPromise<Array<Template>>, PrismaPromise<Array<TemplateGetPayload<T>>>>
    ...
    **/
    ...
    ): CheckSelect<T, Prisma__TemplateClient<Template>, Prisma__TemplateClient<TemplateGetPayload<T>>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends TemplateAggregateArgs>(args: Subset<T, TemplateAggregateArgs>): PrismaPromise<GetTemplateAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, TemplateGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTemplateGroupByPayload<T> : PrismaPromise<InputErrors>
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__TemplateClient<T> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
  ...
  export type TemplateFindUniqueArgs = {
    ...
    **/
    ...
    /**
     * Throw an Error if a Template can't be found
     * 
    **/
    rejectOnNotFound?: RejectOnNotFound
    /**
